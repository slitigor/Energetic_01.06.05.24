...
const AddressEditDialog: FC<DialogProps> = ({ address }) => {
  const [updateAddr, deleteAddr] = useAddressStore((state) => [
    state.updateAddr,
    state.deleteAddr,
  ]);
  ...
  const handleSaveClick = () => {
    if (editAddres.zip && editAddres.city && editAddres.street)
      updateAddr(address.zip, editAddres);
  };
